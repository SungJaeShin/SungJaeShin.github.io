...
## LiDAR의 명칭
LiDAR는 Light Detection And Ranging의 약어이고 다른 말로는 Laser Detection And Ranging
LiDAR (= Light Detection And Ranging LiDAR = Laser Detection And Ranging = ToF (Time of Flight) = Laser Scanner = Laser Rader 로 불리움)
