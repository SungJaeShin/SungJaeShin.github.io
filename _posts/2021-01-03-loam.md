...
---|---
<center>{L}</center> | <center>LiDAR Coordinate System</center>

- {W} : World(Global) Coordinate System
- k   : A sweep as the lidar completes one time of scan coverage
- P<sub>k</sub> : The point cloud perceived during sweep k
- X<sup>L</sup><sub>(k,i)</sub> : The coordinate of a point i, i &#8712; P<sub>k</sub> in {L}
- X<sup>W</sup><sub>(k,i)</sub> : The coordinate of a point i, i &#8712; P<sub>k</sub> in {W}
- t<sub>k</sub> : Starting time of a sweep k
- t<sub>k+1</sub> : Starting time of a sweep k+1
- P<sup>&#8254;</sup> :
- &#949;<sub>k+1</sub> : The sets of edge points
- $$$H<sub>k+1</sub>$$$ : The sets of planar points
-
